...
export default class E10b25 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./E10b25/costumes/costume1.svg", {
        x: 23.125000000000057,
        y: 12.871462264150978
      })
    ];

    this.sounds = [new Sound("pop", "./E10b25/sounds/pop.wav")];
