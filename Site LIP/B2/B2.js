...
export default class B2 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./B2/costumes/costume1.svg", {
        x: 18.187499999999943,
        y: 10.123229351351398
      })
    ];

    this.sounds = [new Sound("pop", "./B2/sounds/pop.wav")];
